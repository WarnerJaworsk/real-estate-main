...
st.write("""
This app predicts the price of a real estate property based on various characteristics related to the property.
""")
...
if submitted:
    ...
    # Make prediction
    predicted_price = dt_model.predict(prediction_input)
...
st.write(
    """Decision Tree machine learning model was used to predict the property price."""
)
st.image("tree2.png")
